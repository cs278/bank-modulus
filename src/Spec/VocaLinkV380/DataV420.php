 ...
 */
final class DataV420 implements DataInterface
{
    /** @internal */
    public function fetchRecord(string $sortCode, int $pass): ?array
    {
        if (
            1 === $pass
            && (
        ...
        if (
            1 === $pass
            && (
                   ('040406' <= $sortCode && $sortCode <= '040606')
            )
        ) {
        ...
        if (
            ...
            && (
                ...
                || ('050022' <= $sortCode && $sortCode <= '058999')
            )
        ) {
        ...
        if (
            1 === $pass
            && (
                   ('170000' <= $sortCode && $sortCode <= '179499')
            )
        ) {
        ...
        if (
            1 === $pass
            && (
                   ('185003' <= $sortCode && $sortCode <= '185025')
                ...
                || ('400516' <= $sortCode && $sortCode <= '404799')
        ...
        if (
            1 === $pass
            && (
                   ('820000' <= $sortCode && $sortCode <= '826917')
